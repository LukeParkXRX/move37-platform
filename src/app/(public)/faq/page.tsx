...
const faqCategories = [
  {
    ...
    items: [
      {
        q: "Move 37이 무엇인가요?",
        a: "Move 37은 미국 진출을 목표로 하는 한국 스타트업과, 미국 Top MBA 재학·졸업생(Enabler)을 연결하는 실행 중심 플랫폼입니다. 단순 조언이 아닌, 실제 실행에 함께 참여하는 전문가와의 협업이 가능합니다.",
      },
      {
        q: "기존 멘토링 서비스와 무엇이 다른가요?",
        a: "대부분의 멘토링 서비스는 경험을 공유하는 수준에 그칩니다. Move 37의 Enabler는 미국 현지에서 직접 실행합니다. 파트너 미팅 세팅, 이메일 작성, IR 자료 수정 등 실제 결과물을 만들어냅니다.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "세션은 어디서 진행되나요?",
        a: "별도 앱 설치 없이 Move 37 플랫폼 내 화상 미팅 기능으로 진행됩니다. 세션 중 메모 작성, 파일 공유가 가능하며, 종료 후 AI가 세션 내용을 자동으로 요약해 제공합니다.",
      },
      {
        q: "세션 후 환불이 가능한가요?",
